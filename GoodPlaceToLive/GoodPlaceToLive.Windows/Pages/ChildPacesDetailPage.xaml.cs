...
namespace GoodPlaceToLive.Pages
{
    ...
    /// </summary>
    public sealed partial class ChildPlacesDetailPage : Page
    {
        ...
        private async void MainMap_OnLoaded(object sender, RoutedEventArgs e)
        {
            ...
            var rmain = ServiceLocator.Current.GetInstance<MainViewModel>();
            var location = new Location(Double.Parse(rmain.CurrentChildItem.Y), Double.Parse(rmain.CurrentChildItem.X));
            map.SetView(location, zoomLevel);

            Pushpin pushpin = new Pushpin();
            MapLayer.SetPosition(pushpin, location);
            pushpin.Name = rmain.CurrentChildItem.Id.ToString();
